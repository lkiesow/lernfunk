...
FeedCreator class v1.7.2.b-ppt
...
v1.7.2b-ppt	04-17-11 
	Fixed little encoding bug -- Lars Kiesow
...
class FeedCreator extends HtmlDescribable {
	...
	*/
	...
	function _createStylesheetReferences() {
		$xml = "";
		if (property_exists( $this, 'cssStyleSheet' )) {
			$xml .= "<?xml-stylesheet href=\"".$this->cssStyleSheet."\" type=\"text/css\"?>\n";
		}
		if (property_exists( $this, 'xslStyleSheet' )) {
