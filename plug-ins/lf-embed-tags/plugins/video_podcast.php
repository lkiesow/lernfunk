...
function plugin_video_podcast( $url, $preview_url, $additional_args ) {
	...
	$class     = array_key_exists( 'class',     $additional_args ) ? $additional_args['class']     : 'videopodcastplayer';
...
bindPlayerPlugin( 'Video Podcast', 'plugin_video_podcast' );
