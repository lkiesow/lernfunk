...
function plugin_screenrecording_podcast( $url, $preview_url, $additional_args ) {
	...
	$class     = array_key_exists( 'class',     $additional_args ) ? $additional_args['class']     : 'screenrecordingpodcastplayer';
...
bindPlayerPlugin( 'Screenrecording Podcast', 'plugin_screenrecording_podcast' );
